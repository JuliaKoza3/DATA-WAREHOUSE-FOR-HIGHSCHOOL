...
FROM 'C:\Users\user\Desktop\data warehouses\matura_2019.bulk'
WITH (
    FIRSTROW = 2,
    FIELDTERMINATOR = '|',
    ROWTERMINATOR = '\n',
...
FROM 'C:\Users\user\Desktop\data warehouses\students_2019.bulk'
WITH (
    FIRSTROW = 2,
    FIELDTERMINATOR = '|',
    ROWTERMINATOR = '\n',
...
FROM 'C:\Users\user\Desktop\data warehouses\student_matura_result_2019.bulk'
WITH (
    FIRSTROW = 2,
    FIELDTERMINATOR = '|',
    ROWTERMINATOR = '\n',
