...
FROM 'C:\Users\user\Desktop\data warehouses\matura_2021.bulk'
WITH (
    FIRSTROW = 2,
    FIELDTERMINATOR = '|',
    ROWTERMINATOR = '\n',
...
FROM 'C:\Users\user\Desktop\data warehouses\students_2021.bulk'
WITH (
    FIRSTROW = 2,
    FIELDTERMINATOR = '|',
    ROWTERMINATOR = '\n',
...
FROM 'C:\Users\user\Desktop\data warehouses\student_matura_result_2021.bulk'
WITH (
    FIRSTROW = 2,
    FIELDTERMINATOR = '|',
    ROWTERMINATOR = '\n',
